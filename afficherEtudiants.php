...
<body onload="refresh()">
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="index1.php">SCO-Enicar</a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="index.html" id="dropdown01" data-toggle="dropdown" aria-expanded="false">Gestion des Groupes</a>              <div class="dropdown-menu" aria-labelledby="dropdown01">
                ...
                <a class="dropdown-item" href="afficherEtudiantsParClasse1.php">Etudiants par Groupe</a>
          ...
          <form class="form-inline my-2 my-lg-0" method="post" action="chercherGroupe.php">
            <input class="form-control mr-sm-2" type="text" name="classe" placeholder="Saisir un groupe" aria-label="Chercher un groupe">
            <button class="btn btn-outline-success my-2 my-sm-0" type="submit" name="recherche">Chercher Groupe</button>
          </form>
        </div>
      </nav>
